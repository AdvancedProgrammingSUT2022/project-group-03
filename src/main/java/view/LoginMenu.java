...
//    private String username, password, nickname;
    private String[] userRegexes = {
            "^--username (\\w+)$",
            "^-u (\\w+)$"
    };

    private String[] nickRegexes = {
            "^--nickname (.+) -$",
            "^-n (.+) -$"
    };

    private String[] passRegexes = {
            "^--password (\\W+)$",
            "^-p (\\W+)$"
    };
    ...
    protected boolean commands(String command) {
        ...
        switch (commandNumber) {
            ...
            case 0:
                return false;
            case 1:
                System.out.println("Login Menu"); break;
            case 2:
                createNewUser(command); break;
            case 3:
    ...
    private boolean loginUser(String command) {
        ...
        switch (outputNumber)
        {
            case 0: System.out.println("user logged in successfully!"); return true;
            case 1,2: System.out.println("Username and password didn’t match!"); return false;
        }
        return true;
    }
}
