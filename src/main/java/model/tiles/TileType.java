...
public enum TileType {
    ...
    FLAT(new FeatureType[]{FeatureType.FOREST, FeatureType.JUNGLE},"FLA",1,-33,1,1,0,
            ...
            new ImprovementType[]{ImprovementType.CAMP,ImprovementType.FARM,ImprovementType.MINE,ImprovementType.PASTURE,ImprovementType.FIELD,ImprovementType.QUARRY,ImprovementType.TRADING_POST,ImprovementType.FACTORY}),
    GRASSLAND(new FeatureType[]{FeatureType.FOREST, FeatureType.SWAMP},"GRA",1,-33,2,0,0,
            ...
            new ImprovementType[]{ImprovementType.FARM,ImprovementType.MINE,ImprovementType.PASTURE,ImprovementType.FIELD,ImprovementType.QUARRY,ImprovementType.TRADING_POST,ImprovementType.FACTORY}),
    HILL(new FeatureType[]{FeatureType.FOREST, FeatureType.JUNGLE},"HIL",2,25,0,2,0,
            ...
            new ImprovementType[]{ImprovementType.CAMP,ImprovementType.MINE,ImprovementType.PASTURE,ImprovementType.QUARRY}),
    ...
    TileType(FeatureType[] featureTypes, String icon,int movementPoint,int combatChange, int food, int production, int gold, ResourcesTypes[] resources, ImprovementType[] improvementTypes)
    {
